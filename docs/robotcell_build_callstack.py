...
def main():
    ...
    y = panel(
        ...
        [
            ...
            "├─ get_planner()                           → cached (client, planner)  robot_cell.py:337",
            "├─ get_or_load_robot_cell()                → cached BARE cell",
            "├─ repair_on_entry(BAR_RADIUS)             # bar-registry hygiene",
            "└─ robot_cell.rebuild_assembly_cell(rcell, planner)   robot_cell.py:824",
            "   ├─ get_bar_seq_map()",
            ...
            "   ├─ build_arm_tool_models()                          robot_cell.py:683",
    ...
    panel(
        ...
        [
            ...
            "└─ bar_action.build_assembly_movements(rcell, planner, bar_id, base, tool0L, tool0R)   bar_action.py:731",
            ...
            "      ├─ robot_cell.ensure_assembly_cell(rcell, planner)          robot_cell.py:945",
            "      │    └─ snapshot present → return cached collision_bodies  (else rebuild_assembly_cell)",
            "      ├─ * robot_cell.base_assembly_cell_state()                  robot_cell.py:751   ← ATTACH tools",
            ...
            "   → _build_m1 … _build_m4  each do template_state.copy()   (Stage 3)",
        ],
        C_TEMPLATE,
        [
            "STAGE 2 complete:",
    ...
    ax.text(50, 2.2,
            ...
            "rcell = the one cached RobotCell.   Stage 3 (M1–M4) begins where Click 3 ends.",
